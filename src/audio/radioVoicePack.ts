...
export const RADIO_VOICE_PACK = Object.freeze([
  clip('takeoff-clearance', 'atc', 'Agent Flight, cleared for takeoff.', 'ms_zira', 1.08),
  clip('takeoff-clearance-12r', 'atc', 'Agent Flight, runway one two right, cleared for takeoff.', 'ms_zira', 1.08),
  clip('takeoff-clearance-30l', 'atc', 'Agent Flight, runway three zero left, cleared for takeoff.', 'ms_zira', 1.08),
  clip('clearance-issued', 'atc', 'Agent Flight, diversion approved. Fly the assigned heading and altitude.', 'ms_zira', 1.08),
  clip('clearance-issued-kstl-30l', 'atc', 'Agent Flight, radar vectors St. Louis Lambert. Expect runway three zero left.', 'ms_zira', 1.08),
  clip('clearance-issued-kmdw-31c', 'atc', 'Agent Flight, cleared to Chicago Midway. Expect runway three one center.', 'ms_zira', 1.08),
  clip('landing-clearance', 'atc', 'Agent Flight, cleared to land.', 'ms_zira', 1.06),
  clip('landing-clearance-30l', 'atc', 'Agent Flight, runway three zero left, cleared to land.', 'ms_zira', 1.06),
  clip('landing-clearance-31c', 'atc', 'Agent Flight, runway three one center, cleared to land.', 'ms_zira', 1.06),
